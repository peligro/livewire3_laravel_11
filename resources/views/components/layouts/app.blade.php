...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MVP - {{ $title ?? 'Page Title' }}</title>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 link-secondary" href="{{route('ruta_home')}}" wire:navigate>Home</a>
      <a class="p-2 link-secondary" href="{{route('ruta_parametros', ['id'=>'1', 'slug'=>'maria'])}}?search=veamos" wire:navigate>Parámetros</a> 
  ...
  <p>@copy Todos los derechos reservados {{date('Y')}} | Desarrollado por <a href="https://www.cesarcancino.com" target="_blank">César Cancino</a>.</p>
